...
// *************************************************
// Implemented a "move forward" to draw and "move back" to move cursor system
// ScreenTap for "New" button (still needs some work)
// *************************************************
...
// *************************************************
// Ive commented out the code below because Im not really sure what the point of it is
// Its screwing up the push to draw
// Ive added "lastFingerPos = fingerPos" further down
// If this is not needed then delete this code:
// *************************************************

   /* if (lastFingerPos.x <= -1000) {
      lastFingerPos = fingerPos; 
    }   
    else if (lastFingerPos.x > -1000) {
